...
import SignInAndUpInput, { formStateProps } from './SignInAndUpInput';
  ...
  return (
    <Form onSubmit={submitHandler} {...props}>
      <InputSet>
        {option === 'signin' && (
          <>
            {(['id', 'pwd'] as Array<keyof formStateProps>).map(
              (option, idx) => (
                <SignInAndUpInput
                  key={idx}
                  option={option}
        ...
        {option === 'signup' && (
          <>
            {(
              ['id', 'nickname', 'pwd', 'pwdCheck'] as Array<
                keyof formStateProps
              >
            ).map((option, idx) => (
              <SignInAndUpInput
                key={idx}
